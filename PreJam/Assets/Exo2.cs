...
public class Exo2 : MonoBehaviour
{
    ...
    //
    //Déclarer une variable de référence au VFX
    //Déclarer une variable de nombre décimale qui définira le rayon d'action
    //Déclarer uen variable de nombre entier qui définira le nombre de VFX a spawn
